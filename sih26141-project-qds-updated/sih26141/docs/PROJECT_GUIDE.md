...
**Version 2 — post-QDS-upgrade edition.** Supersedes the original guide.
...
threshold (§1.8) — with base threshold 15%, that's around f ≈ 60–70%.
...
- **App.tsx** — parameter state (key length 1k–100k, threshold, pace, custom
  ...
  progress ingestion, verdict logs), sweep calls, 10-s health poll.
