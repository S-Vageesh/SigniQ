...
// ---------------------------------------------------------------------------
// Forgery probability analysis (deliverable 5)
// ---------------------------------------------------------------------------

/// Theoretical single-position forgery success probability for a forger who
/// guesses Bell outcomes uniformly at random: the guessed correction must map
/// the payload to the verification bit, which happens for 1 of 4 outcomes.
pub const THEORY_SINGLE_POSITION_FORGERY_P: f64 = 0.25;
